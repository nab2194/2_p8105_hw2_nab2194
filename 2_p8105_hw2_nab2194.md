...
state of the stock market, and the unemployment rate from NA to NA and
is also disaggregated by month. The average unemployment rate across all
years from 1947 to 2015 (excluding missing values) was NA
